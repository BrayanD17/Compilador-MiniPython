...
public interface IMiniPythonParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMoreStatements([NotNull] MiniPythonParser.MoreStatementsContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MiniPythonParser.moreStatements"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMoreStatements([NotNull] MiniPythonParser.MoreStatementsContext context);
	/// <summary>
