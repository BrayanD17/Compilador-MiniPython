...
public partial class MiniPythonParserBaseListener : IMiniPythonParserListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="MiniPythonParser.moreStatements"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMoreStatements([NotNull] MiniPythonParser.MoreStatementsContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MiniPythonParser.moreStatements"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMoreStatements([NotNull] MiniPythonParser.MoreStatementsContext context) { }
	/// <summary>
